...
Everything moves at the speed of light *c* through spacetime.
Only the direction — between space and time — differs.
...
jupyter-book build book/en/
jupyter-book build book/nl/
```
